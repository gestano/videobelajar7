    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <p className="mt-4 leading-relaxed text-slate-700">
          VideoBelajar adalah platform pembelajaran video berbasis web yang memberi pengguna akses
          ke beragam kursus dan tutorial berbasis video. Dengan VideoBelajar, pengguna dapat
          ...
          VideoBelajar menawarkan berbagai kursus dan tutorial, mencakup topik seperti bisnis,
